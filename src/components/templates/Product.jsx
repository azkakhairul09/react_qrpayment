                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        {this.state.products.map((product, i) => (
                                            <tr key={i}>
                                            <td>
                                                <div style={{color:"#007bff", cursor:"pointer"}} onClick={() => { if (window.confirm('Are you sure to delete this item?')) this.disactive(product.productId) }}><i className="fas fa-minus-circle" style={{color: "red"}}></i></div>
                                            </td>
